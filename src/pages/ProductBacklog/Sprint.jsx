    ...
    <div className="max-w-xl mx-auto p-6 bg-gray-100 rounded-3xl shadow-xl mt-6">
      ...
      <div className="space-y-4">
        ...
        {sprints.map((s, idx) => (
          <div
            key={s.id}
            className="p-5 rounded-3xl text-white flex justify-between items-center shadow-md hover:-translate-y-1 transition-transform"
            style={{
          ...
          >
            <div>
              ...
              <p className="text-sm opacity-80">{s.goal}</p>
            </div>
